import type { Opportunity } from "../../../Projeto /mini-seler-console/src/types"
import { Card } from "../../../Projeto /mini-seler-console/src/components/ui/Card"
import { Badge } from "../../../Projeto /mini-seler-console/src/components/ui/Badge"
  ...
  return (
    <Card>
      <div className="p-4 border-b">
        ...
        <p className="text-sm text-gray-600">Converted leads tracking through the sales pipeline</p>
      </div>
